...
from .common import printdebug, print_to_stderr, urlparse
...
def create_classic_pat(config, debug):
...
def get_newly_generated_pat(driver, debug):
    ...
    newly_generated_pat = \
        driver.find_element(By.XPATH, xpath).get_attribute('innerHTML')
