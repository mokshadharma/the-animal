...
from .common import lookup_domain_in_dns, printdebug, printerr_exit
    ...
    if 'chrome' == config['selenium']['driver']:
        ...
        if config['selenium']['headless']:
            ...
            chrome_options.add_argument(
                f"--window-size={headless_window_size}")
...
def setup_webdriver(config, debug):
    """setup selenium logging and start webdriver"""
